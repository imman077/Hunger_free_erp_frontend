...
const VolunteerRewards = () => {
  ...
  const isFormValid = useMemo(() => {
    ...
    const isTravelReward = rewards.tours.some(
      (t: any) => t.id === selectedReward.id,
    );
    // Gift rewards (Youth/Gifts & Shop category)
    const isGiftReward = rewards.youth.some((y: any) => y.id === selectedReward.id);
      ...
      >
        <div className="flex flex-col h-full overflow-hidden">
          <div className="p-8 space-y-8 flex-1 overflow-y-auto thin-scrollbar">
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <ResuableDatePicker
                      ...
                      value={claimDate}
                      onChange={(date: any) => setClaimDate(date)}
                    />
                  </div>
            ...
            {selectedReward &&
              rewards.youth.some((y: any) => y.id === selectedReward.id) && (
                <div className="space-y-6">
                  <div className="space-y-4">
                    <h4
                      className="text-[11px] font-black uppercase tracking-widest"
            ...
            >
              ...
              >
                {selectedReward &&
                rewards.tours.some((t: any) => t.id === selectedReward.id)
