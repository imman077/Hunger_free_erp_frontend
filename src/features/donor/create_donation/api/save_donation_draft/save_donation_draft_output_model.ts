...
export const saveDonationDraftOutputSchema = z.object({
  loading: z.boolean().default(false),
  data: z.object({
    saveDonationDraft: z.object({
...
export const saveDonationDraftOutputPersistenceConfig = {
  loading: false,
  data: true,
};

export const saveDonationDraftOutputSchemas = createSchemaBundle(
...
export type SaveDonationDraftOutput = z.infer<typeof saveDonationDraftOutputSchema>;
