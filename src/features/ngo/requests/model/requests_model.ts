...
export const donationRequestSchema = z.object({
  ...
  supporters_details: z.array(z.any()).optional(),
  supporter_ids: z.array(z.any()).optional(),
  fulfilled_quantity: z.number().optional(),
  quantity_num: z.number().optional(),
...
export const requestsStateSchema = z.object({
  ...
  subTab: z.enum(["all", "mine", "my-need"]).default("all"),
  ...
  sortFilter: z.string().default("NEWEST"),
