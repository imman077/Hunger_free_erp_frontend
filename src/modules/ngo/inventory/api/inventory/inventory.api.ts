...
import { AddItemInputSchema, UpdateItemInputSchema, DeleteItemInputSchema } from "./inventory.input";
import type { AddItemInput, DeleteItemInput } from "./inventory.input";
import {
  GetInventoryResponseSchema,
  AddItemResponseSchema,
  UpdateItemResponseSchema,
  DeleteItemResponseSchema,
} from "./inventory.output";
import type { GetInventoryResponse, AddItemResponse, UpdateItemResponse } from "./inventory.output";
