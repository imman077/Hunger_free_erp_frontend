...
import { DONOR_ENQUIRY_COLUMNS } from "../store/enquiry-constants";
...
const DonorEnquiryPage = ({ hideHeader = false }: { hideHeader?: boolean }) => {
  ...
  const donorEnquiries = registrations.filter((e) => e.type.includes("Donor"));
          ...
          <div className="space-y-8 p-3 sm:p-4 lg:p-5">
            ...
            >
              ...
              >
                ...
                <span className="truncate">Verify Donor</span>
              </button>
              <button
                onClick={() =>
