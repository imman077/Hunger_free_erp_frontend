...
import { VOLUNTEER_ENQUIRY_COLUMNS } from "../store/enquiry-constants";
...
const VolunteerEnquiryPage = ({
  ...
  const volunteerEnquiries = registrations.filter((e) =>
    e.type.includes("Volunteer"),
  );
          ...
          >
            ...
            >
              <div className="overflow-x-auto">
                <ReusableTable
                  data={volunteerEnquiries}
                  columns={VOLUNTEER_ENQUIRY_COLUMNS}
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p
                        ...
                        style={{ color: "var(--text-primary)" }}
                      >
                        {selectedEnquiry.docType || "Identity"} Verification
                      </p>
                  ...
                  >
                    <button
                      onClick={() =>
                        setPreviewDoc({
                          name: `${selectedEnquiry.docType || "Identity"} Verification`,
