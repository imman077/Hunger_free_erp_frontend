...
import { AcceptPickupInputSchema, MarkAsPickedUpInputSchema, MarkAsDeliveredInputSchema } from "./tasks.input";
import type { AcceptPickupInput } from "./tasks.input";
import {
...
import type { GetNearbyPickupsResponse, AcceptPickupResponse, GetMyTasksResponse } from "./tasks.output";
